...
public class SubcategoriaController {
    ...
    public ResponseEntity<List<SubcategoriaResponse>> porCategoria(@PathVariable UUID categoriaId) {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<SubcategoriaResponse> actualizar(@PathVariable UUID id, @Valid @RequestBody SubcategoriaRequest request) {
